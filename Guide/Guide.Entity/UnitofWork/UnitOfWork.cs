...
namespace Guide.Entity.UnitofWork
{
    ...
    public class UnitOfWork : IUnitOfWork
    {
        ...
        public IRepository<TEntity> GetRepository<TEntity>() where TEntity : class
        {
            ...
            if (!_repositories.ContainsKey(type)) _repositories[type] = new Guide.Entity.Repository.Repository<TEntity>(this);
